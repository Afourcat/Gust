...
fn main()
{
    ...
    let vert_arr = VertexArray::from(vec![
            Vertex::new(Vector::new(800.0, 400.0), Vector::new(200.0, 0.0), Color::new(0.0, 1.0, 0.0)),
            Vertex::new(Vector::new(1200.0, 700.0), Vector::new(20.0, 10.0), Color::new(0.0, 1.0, 1.0)),
